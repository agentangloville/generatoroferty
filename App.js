...
const STEPS = [
  ...
  },
  {
    ...
    emoji: "🎯",
    subtitle: "Jeden cel = lepiej skrojony program",
    showFor: ["me"],
    options: [
      { id: "barrier", label: "Przełamać barierę mówienia", emoji: "💬", desc: "Milknę przy obcokrajowcach, chcę to zmienić" },
      { id: "career", label: "Kariera i praca", emoji: "💼", desc: "Potrzebuję angielskiego zawodowego" },
      { id: "travel", label: "Podróże i swoboda", emoji: "✈️", desc: "Chcę rozmawiać bez stresu na całym świecie" },
      { id: "exam", label: "Egzamin / certyfikat", emoji: "📜", desc: "Przygotowuję się do FCE, IELTS, TOEFL" },
    ],
  },
  ...
  {
    id: "child_goal",
    question: "Co jest najważniejsze dla Twojego dziecka?",
    emoji: "🌟",
    subtitle: "Pomożemy wybrać program, który naprawdę trafi w sedno",
    showFor: ["child"],
    options: [
      { id: "barrier", label: "Przełamać barierę mówienia", emoji: "💬", desc: "Rozumie, ale nie mówi" },
      { id: "matura", label: "Przygotowanie do matury", emoji: "📝", desc: "Matura ustna z angielskiego" },
      { id: "adventure", label: "Przygoda + angielski", emoji: "✈️", desc: "Wycieczka + nauka za granicą" },
      { id: "fun", label: "Wakacje pełne angielskiego", emoji: "🎉", desc: "Fajne wakacje i przy okazji nauka" },
    ],
  },
  {
    id: "destination",
    ...
    emoji: "🌍",
    subtitle: "Obydwie opcje działają — ale zagranica to inny poziom przygody",
    showFor: ["child"],
    options: [
      ...
      { id: "unsure", label: "Nie wiem, doradź mi", emoji: "🤔", desc: "Opowiedz mi o opcjach" },
    ],
  },
  {
    id: "teen_goal",
    ...
    emoji: "🎯",
    subtitle: "Powiemy Ci, który program da najlepsze efekty",
    showFor: ["teen"],
    options: [
      { id: "barrier", label: "Przełamać barierę mówienia", emoji: "💬", desc: "Rozumiem, ale nie mówię — chcę to zmienić" },
      { id: "matura", label: "Matura ustna z angielskiego", emoji: "📝", desc: "Chcę się naprawdę przygotować" },
