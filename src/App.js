...
const STEPS = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "matura", label: "Matura się zbliża", emoji: "📝", desc: "Trzeba zdać maturę ustną — deadline goni" },
      { id: "grades", label: "Słabe oceny z angielskiego", emoji: "📉", desc: "Szkoła nie daje efektów mimo kursów" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "matura", label: "Zdać maturę ustną", emoji: "📝", desc: "Mam maturę i serio muszę się przygotować" },
  ...
  },
  {
    ...
    emoji: "🎂",
    subtitle: "Różne programy mają różne przedziały wiekowe",
    showFor: ["teen"],
    options: [
  ...
  },
  {
    ...
    showFor: ["teen"],
    options: [
      { id: "school_only", label: "Tylko szkoła", emoji: "🏫", desc: "Lekcje, testy — ale mówić wciąż nie umiem" },
      { id: "tutor", label: "Korepetytor / kurs online", emoji: "💻", desc: "Dodatkowe lekcje, ale bez przełomu" },
      { id: "camp_pl", label: "Obóz językowy w Polsce", emoji: "🇵🇱", desc: "Byłem/am — chcę czegoś więcej" },
      { id: "nothing", label: "Nic — chcę zacząć dobrze", emoji: "🚀", desc: "Wolę zacząć od skutecznej metody" },
    ],
  },
];

function getRecommended(answers) {
  const { who, level, child_age, destination, teen_goal, teen_age } = answers;

  if (who === "family") return {
    key: "family", name: "Angloville Family", icon: "👪",
    tag: "Rodzina · Polska", price: "od 7 000 zł (rodzic + dziecko)",
    link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-family/",
    altLinks: [
      { label: "Angielska Wioska (dla dorosłych)", url: "https://angloville.pl/dla-doroslych/angielska-wioska/" },
      { label: "Angloville Kids (dzieci 7-11)", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-kids/" },
    ],
  };

  if (who === "me") {
    if (answers.goal === "travel") return {
      key: "adult_travel", name: "Wyjazdy turystyczno-językowe", icon: "✈️",
      tag: "Dorośli · Świat", price: "Indywidualna wycena",
    ...
    if (level === "beginner") return {
      key: "beginners", name: "Angielska Wioska dla Początkujących", icon: "🌱",
      tag: "Dorośli · A1–A2 · Polska", price: "od 3 700 zł",
      link: "https://angloville.pl/dla-doroslych/nauka-od-podstaw/",
      altLinks: [{ label: "Angielska Wioska (standard)", url: "https://angloville.pl/dla-doroslych/angielska-wioska/" }],
    };
    return {
      key: "adult_standard", name: "Angielska Wioska w Polsce", icon: "🏡",
      tag: "Dorośli · 6 dni · Polska", price: "od 3 700 zł",
      link: "https://angloville.pl/dla-doroslych/angielska-wioska/",
      altLinks: [
  ...
  if (who === "child") {
    if (child_age === "a7") return {
      key: "kids", name: "Angloville Kids", icon: "🧸",
      tag: "Dzieci 7–11 lat · Polska", price: "od 3 700 zł",
      link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-kids/",
      altLinks: [{ label: "Angloville Family (z rodzicem)", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-family/" }],
    };
    const childGoal = answers.child_goal;
    if (childGoal === "adventure" || destination === "world") return {
      key: "world", name: "USA / Nowy Jork / Kalifornia / Miami / Japonia", icon: "🌎",
      tag: "Młodzież 14–18 lat · Świat", price: "Indywidualna wycena",
    ...
    if (destination === "europe") {
      if (child_age === "a13" || child_age === "a15") return {
        key: "malta", name: "Junior International — Malta", icon: "🌊",
        tag: "Młodzież 13–18 lat · Malta", price: "od 8 900 zł",
        link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-international-malta/",
        altLinks: [
          { label: "Junior International – Anglia", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-international-anglia/" },
          { label: "UK Trip – Londyn, Oxford, Cambridge", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-plus-londyn/" },
          { label: "Italy Trip – Rzym, Florencja, Wenecja", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-plus-italy-trip/" },
        ],
      };
      return {
        key: "uk_trip", name: "Junior Plus — UK Trip", icon: "🇬🇧",
        tag: "Młodzież 12–18 lat · Londyn", price: "od 6 500 zł",
        link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-plus-londyn/",
        altLinks: [
    ...
    return {
      key: "junior", name: "Angloville Junior", icon: "🎒",
      tag: "Młodzież 11–18 lat · Polska", price: "od 3 700 zł",
      link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior/",
      altLinks: [
  ...
  if (who === "teen") {
    if (teen_goal === "usa_year") {
      ...
      if (ageOkUSA) return {
        key: "usa", name: "Rok Szkolny w USA", icon: "🗽",
        tag: "Licealiści 15–18.5 lat · USA", price: "Indywidualna wycena",
        link: "https://angloville.pl/dla-dzieci-i-mlodziezy/rok-w-usa/", ageNote: null,
        altLinks: [
      ...
      if (ageOkCanada) return {
        key: "canada", name: "Rok Szkolny w Kanadzie", icon: "🍁",
        tag: "Licealiści 14–18.5 lat · Kanada", price: "Indywidualna wycena",
        link: "https://angloville.pl/dla-dzieci-i-mlodziezy/rok-w-kanadzie/",
      ...
      return {
        key: "too_young_usa", name: "Angloville Junior International — Malta", icon: "🌊",
        tag: "Młodzież 13–18 lat · Malta", price: "od 8 900 zł",
        link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-international-malta/",
        ageNote: "Masz 11–12 lat — rok w USA wymaga min. 15 lat, rok w Kanadzie 14 lat. Proponujemy intensywny obóz za granicą, który świetnie Cię przygotuje! 🇺🇸 Marzenie o USA staje się realne za 2–3 lata.",
        altLinks: [
          { label: "Rok w USA (od 15 lat)", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/rok-w-usa/" },
          { label: "Junior International – Anglia", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-international-anglia/" },
          { label: "UK Trip – Londyn, Oxford, Cambridge", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-plus-londyn/" },
    ...
    if (teen_goal === "adventure") {
      if (teen_age === "t15" || teen_age === "t17") return {
        key: "world_teen", name: "USA Trip / Nowy Jork / Kalifornia / Japonia", icon: "🌎",
        tag: "Młodzież 14–18 lat · Świat", price: "Indywidualna wycena",
        link: "https://angloville.pl/dla-dzieci-i-mlodziezy/nowy-jork/",
        altLinks: [
          { label: "Nowy Jork 14–18", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/nowy-jork/" },
      ...
      return {
        key: "uk_trip_teen", name: "Junior Plus — UK Trip", icon: "🇬🇧",
        tag: "Młodzież 12–18 lat · Londyn", price: "od 6 500 zł",
        link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-plus-londyn/",
        altLinks: [
          { label: "Junior International – Malta", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-international-malta/" },
    ...
    return {
      key: "junior_teen", name: "Angloville Junior", icon: "🎒",
      tag: "Młodzież 11–18 lat · Polska", price: "od 3 700 zł",
      link: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior/",
      altLinks: [
        { label: "Junior International – Malta", url: "https://angloville.pl/dla-dzieci-i-mlodziezy/angloville-junior-international-malta/" },
  ...
  return {
    key: "adult_standard", name: "Angielska Wioska w Polsce", icon: "🏡",
    tag: "Dorośli · 6 dni · Polska", price: "od 3 700 zł",
    link: "https://angloville.pl/dla-doroslych/angielska-wioska/", altLinks: [],
  };
}
...
function AIBlock({ title, content, loading, emoji }) {
  return (
    <div style={{ background: "rgba(66,139,202,0.1)", border: "1px solid rgba(66,139,202,0.3)", borderRadius: 16, padding: "22px 24px", marginBottom: 16 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
        ...
        {loading && (
          <div style={{ marginLeft: "auto", display: "flex", gap: 4 }}>
            {[0,1,2].map(i => (
              <div key={i} style={{ width: 6, height: 6, borderRadius: "50%", background: "#428BCA", animation: "pulse 1.2s ease-in-out infinite", animationDelay: i * 0.2 + "s" }} />
            ))}
          </div>
        )}
      </div>
...
BAZA WIEDZY: ${ANGLOVILLE_KNOWLEDGE}`;
    const prompt = `Profil klienta: ${JSON.stringify(ans, null, 2)}
Napisz spersonalizowany tekst edukacyjny przed pokazaniem oferty. Wyjaśnij DLACZEGO ma problem z angielskim i jak immersja Angloville to rozwiąże. Buduj pożądanie przez edukację.`;
    try {
      setAiEdu(await callClaude(system, prompt));
    } catch (e) {
      setAiEdu("Angloville działa od 2011 roku i pomogło tysiącom osób przełamać barierę językową. Metoda pełnej immersji to najskuteczniejszy sposób nauki — 7 dni = odpowiednik 400 godzin tradycyjnych lekcji.");
    }
    setLoadingEdu(false);
  }
...
Piszesz po POLSKU. Odpowiedź TYLKO jako JSON (bez markdown, bez backtick) z polami:
tagline, description (3-4 zdania), whyThis (2-3 zdania), highlights (tablica 5 punktów max 8 słów każdy), urgency (1 zdanie), review (opinia uczestnika), reviewAuthor.
BAZA WIEDZY: ${ANGLOVILLE_KNOWLEDGE}`;
    const prompt = `Profil: ${JSON.stringify(ans)} | Program: ${rec.name} (${rec.tag}) | Cena: ${rec.price}`;
    try {
      const text = await callClaude(system, prompt);
      setAiOnePager(JSON.parse(text.replace(/```json|```/g, "").trim()));
    } catch (e) {
      setAiOnePager({
        ...
        whyThis: "Na podstawie Twoich odpowiedzi ten program jest najlepiej dopasowany do Twoich celów.",
        highlights: ["70h aktywnej komunikacji", "Native Speakerzy z UK, USA, Irlandii", "Zakwaterowanie + wyżywienie w cenie", "Różne akcenty w jednym miejscu", "Płatność do 6 rat 0%"],
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#232323" }}>
      ...
      <div style={{ maxWidth: 580, margin: "0 auto", padding: "24px 16px 80px" }}>
        ...
        {phase === "edu" && (
          <div style={{ animation: "fadeIn 0.4s ease" }}>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <h2 style={{ color: "#fff", fontFamily: FONT, fontWeight: 800, fontSize: 22, margin: "0 0 8px" }}>Zanim zobaczysz ofertę — to musisz wiedzieć</h2>
              <p style={{ color: "rgba(255,255,255,0.5)", fontFamily: FONT, fontSize: 14, margin: 0 }}>Przygotowuję dla Ciebie spersonalizowaną analizę</p>
            </div>
            <AIBlock emoji="🎯" title="Twoja sytuacja językowa — analiza" loading={loadingEdu} content={aiEdu} />
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 14, padding: "20px 22px", marginBottom: 16 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                {[["od 2011","na rynku"],["10 000+","uczestników rocznie"],["4.8 ★","średnia Google (1948 opinii)"],["400h","= 7 dni w Angielskiej Wiosce"],["1:2","native speaker do uczestników"],["6 rat 0%","elastyczna płatność"]].map(([val, lab]) => (
                  <div key={lab}>
            ...
            <button onClick={handleSeeOffer} disabled={loadingEdu} style={{
        ...
        {phase === "result" && (
          <div style={{ animation: "fadeIn 0.4s ease" }}>
            <div style={{ background: "linear-gradient(135deg,#1a2a3a,#1e1e2e)", borderRadius: 20, padding: "28px 24px", marginBottom: 16, border: "2px solid rgba(66,139,202,0.35)", position: "relative", overflow: "hidden" }}>
              ...
              {rec.ageNote && (
                <div style={{ background: "rgba(252,210,58,0.12)", border: "1px solid rgba(252,210,58,0.35)", borderRadius: 12, padding: "14px 16px", marginBottom: 16, display: "flex", alignItems: "flex-start", gap: 10 }}>
              ...
              {aiOnePager && !loadingOnePager && (
                <div style={{ color: "#FCD23A", fontFamily: FONT, fontWeight: 700, fontSize: 16, fontStyle: "italic", margin: "12px 0 14px", lineHeight: 1.4 }}>"{aiOnePager.tagline}"</div>
              )}
              <AIBlock emoji="📋" title="O tym programie" loading={loadingOnePager} content={aiOnePager ? aiOnePager.description : null} />
              <AIBlock emoji="🎯" title="Dlaczego właśnie ten program dla Ciebie" loading={loadingOnePager} content={aiOnePager ? aiOnePager.whyThis : null} />
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "rgba(66,139,202,0.15)", border: "1px solid rgba(66,139,202,0.35)", borderRadius: 14, padding: "18px 20px", flexWrap: "wrap", gap: 14 }}>
                <div>
                ...
                <a href={rec.link} target="_blank" rel="noopener noreferrer" style={{ background: "#FCD23A", color: "#232323", fontFamily: FONT, fontWeight: 800, fontSize: 15, padding: "14px 24px", borderRadius: 12, textDecoration: "none", whiteSpace: "nowrap", display: "inline-block" }}>
            ...
            {!loadingOnePager && aiOnePager && (
              <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 14, padding: "18px 20px", marginBottom: 16 }}>
                ...
                <div style={{ color: "rgba(255,255,255,0.75)", fontFamily: FONT, fontSize: 14, lineHeight: 1.7, fontStyle: "italic", marginBottom: 8 }}>"{aiOnePager.review}"</div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {rec.altLinks.map(alt => (
                    <a key={alt.url} href={alt.url} target="_blank" rel="noopener noreferrer" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 12, padding: "12px 16px", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <button onClick={handleReset} style={{ background: "transparent", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 12, padding: "12px", color: "rgba(255,255,255,0.5)", fontFamily: FONT, fontSize: 14, cursor: "pointer", width: "100%" }}>
              ↩ Zacznij od nowa
            </button>
          </div>
        )}
